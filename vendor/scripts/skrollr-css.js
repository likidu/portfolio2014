...
(function(window, document, undefined) {
	...
	// https://github.com/dremonkey/skrollr-stylesheets/compare/0.0.4-expose-applyKeyframes
	var animations = {};
	var selectors = [];
	...
	var kickstart = function(stylesheets) {
		...
		for(var stylesheetIndex = 0; stylesheetIndex < stylesheets.length; stylesheetIndex++) {
			...
			if(sheet.tagName === 'LINK') {
				...
				console.log("Skrollr-css loaded.");
	...
	var applyKeyframeAttributes = function(_animations, _selectors) {
		var elements;
		var keyframes;
		var keyframeName;
		var elementIndex;
	...
	window.skrollrStylesheets = {
		applyKeyframeAttributes: applyKeyframeAttributes
	}
}(window, document));
